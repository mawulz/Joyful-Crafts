        ...
        <div class="all-form">
            <div id="border-form">
                ...
                {{-- <div class="role-box">
                    ...
                    <div class="rolefield">
                        <input type="radio" class="form-check-input " id="Parent" value="Parent" name="role">
                        <label class="check-parent">Parent</label>
                    </div>
                    <div class="rolefield">
                        <input type="radio" class="form-check-input" id="Community" value="Community" name="role">
                        <label class="check-community">Community</label>
                    </div>
                    <div class="rolefield">
                        <input type="radio" class="form-check-input" id="Guest" value="Guest" name="role">
                        <label class="check-guest">Guest</label>
                    </div>
                </div> --}}
                </div>
                <div class="field">
                ...
                <div class="rolefield">
                    <input type="checkbox" class="form-check-input" id="confirm" value="confirm" name="confirm">
                    <label class="check-confirm">I agree to let Joyful Crafts store my data</label>
                </div>
