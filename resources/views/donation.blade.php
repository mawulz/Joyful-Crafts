...
@section('donate-content')
    <div class="d-flex justify-content-center">
        <form class="form" action="{{ route('donation.store') }}" method="POST">
            @csrf
            <div class="card" id="card1">
                <span class="title">Donor Information</span>
                <div class="group">
                    <input placeholder="" type="text" id="name" name="donor_name" value="{{ old('nama') }}" />
                ...
                <div class="group">
                    <input placeholder="" type="text" id="name" name="donor_email" value="{{ old('email') }}" />
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="anonim">Donate as Anonymous</label>
                </div>
            </div>
